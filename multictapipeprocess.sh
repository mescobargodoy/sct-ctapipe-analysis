...
$SCTCTAPIPEANALYSISDIR/src/fill_file_from_config.sh "$skeleton_configfile" "$ctapipe_process_config_file" 'temp/temp_config.yaml' 
...
first_pass=$($SCTCTAPIPEANALYSISDIR/src/word_finder.sh "$ctapipe_process_config_file" 'image_pe')
second_pass=$($SCTCTAPIPEANALYSISDIR/src/word_finder.sh "$ctapipe_process_config_file" 'neighbor_pe')
time_lim=$($SCTCTAPIPEANALYSISDIR/src/word_finder.sh "$ctapipe_process_config_file" 'delta_time')
